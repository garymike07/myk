...
document.addEventListener('DOMContentLoaded', function() {
    ...
    initializeParticles();
    initializeGsapAnimations(); // Replaces initializeProjectCards
...
function initializeBackToTop() {
    ...
    backToTop.style.cssText = `
        ...
        height: 50px;
        border-radius: 50%;
        background: linear-gradient(135deg, #00f5d4, #00bbf9, #f15bb5);
        color: white;
        border: none;
        cursor: pointer;
        opacity: 0;
...
function initializeDeveloperTools() {
    ...
    console.log('%c🚀 Welcome to Gary Mike\'s Portfolio!', 'color: #00f5d4; font-size: 20px; font-weight: bold;');
    console.log('%cKeyboard Shortcuts:', 'color: #00bbf9; font-size: 14px; font-weight: bold;');
    console.log('%c• Ctrl/Cmd + D: Toggle Dark Mode', 'color: #f15bb5; font-size: 12px;');
    console.log('%c• Ctrl/Cmd + H: Go to Home', 'color: #f15bb5; font-size: 12px;');
}
        ...
        particles.forEach((particle, i) => {
            particles.slice(i + 1).forEach(otherParticle => {
                ...
                if (distance < 100) {
                    ...
                    ctx.strokeStyle = `rgba(0, 245, 212, ${0.1 * (1 - distance / 100)})`;
                    ctx.lineWidth = 1;
                    ctx.stroke();
                }
            });
